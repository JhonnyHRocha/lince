...
use Lince\Validators\RevendedoresValidator;
use Prettus\Validator\Exceptions\ValidatorException;

class RevendedoresService
{
    ...
    public function __construct(RevendedoresRepository $repository, RevendedoresValidator $validator){
